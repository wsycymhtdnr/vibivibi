...
import com.lyf.vibi.ui.banner.indicator.CircleIndicator;
 ...
 */
public class BannerDelegate implements ViewPager.OnPageChangeListener, IBanner {
    private Context mContext;
    private Banner mBanner;
    private BannerAdapter mAdapter;
    private Indicator mHiIndicator;
    private boolean mAutoPlay;
    private boolean mLoop;
    private List<? extends BannerMo> mHiBannerMos;
    ...
    public BannerDelegate(Context context, @NonNull Banner banner) {
        mContext = context;
        mBanner = banner;
    }

    @Override
    public void setBannerData(@LayoutRes int layoutResId, @NonNull List<? extends BannerMo> models) {
        mHiBannerMos = models;
        init(layoutResId);
    }
    ...
    @Override
    public void setHiIndicator(Indicator hiIndicator) {
    ...
    private void init(@LayoutRes int layoutResId) {
        ...
        if (mHiIndicator == null) {
            mHiIndicator = new CircleIndicator(mContext);
        }
        ...
        mHiViewPager = new BannerViewPager(mContext);
